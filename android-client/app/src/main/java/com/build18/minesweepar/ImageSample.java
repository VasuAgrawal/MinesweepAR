...
public class ImageSample extends Activity implements CvCameraViewListener2 {
...
// Explicitly deallocate Mats
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (ImageSample.viewMode) {
            case ImageSample.VIEW_MODE_RGBA:
                break;

            case ImageSample.VIEW_MODE_HIST:
                Mat hist = new Mat();
...
// Hue
            ...
            case ImageSample.VIEW_MODE_CANNY:
            ...
            case ImageSample.VIEW_MODE_SOBEL:
            ...
            case ImageSample.VIEW_MODE_SEPIA:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
                Core.transform(rgbaInnerWindow, rgbaInnerWindow, mSepiaKernel);
                rgbaInnerWindow.release();
                break;

            case ImageSample.VIEW_MODE_ZOOM:
            ...
            case ImageSample.VIEW_MODE_PIXELIZE:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
            ...
            case ImageSample.VIEW_MODE_POSTERIZE:
/*
